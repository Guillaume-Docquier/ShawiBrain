...
//Fix dates format
function fixDates(list, lookupKey)
{
...
//Fix date format
// date like "10-11 juin 2017" should be converted to [{date: 10 juin 2017}, {date: 11 juin 2017}]
// "6 et 20 juin, 4 et 18 juillet, 8 et 22 août 2017"
// "3 juin 2017"
function fixDate(stringDate)
{
    ...
    for(var i = 0; i < dateSets.length; i++)
    {
        ...
        if(pos != -1)
        {
            ...
            //Find end date
            pos = date.indexOf(' ');
            var endDate = date.slice(0, pos);
            date = date.slice(pos + 1, date.length); // remove space
...
//Entry point to wit
function sendRequestToWit(req, callback){
